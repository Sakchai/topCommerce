...
namespace Nop.Plugin.Api.Infrastructure
{
	...
	public class ApiStartup : INopStartup
	{
		public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
		{
			...
			{
                services.Configure<ApiConfiguration>(apiConfigSection);
                var apiConfig = apiConfigSection.Get<ApiConfiguration>();
                //var apiConfig = new ApiConfiguration {
                //    AllowedClockSkewInMinutes = int.Parse(apiConfigSection["AllowedClockSkewInMinutes"]),
                //    SecurityKey = apiConfigSection["SecurityKey"],
                //    ValidIssuer = apiConfigSection["ValidIssuer"],
                //    ValidAudiences = apiConfigSection["ValidIssuer"]
                //};
						...
						options.DefaultChallengeScheme = JwtBearerDefaults.AuthenticationScheme;
							...
							.AddJwtBearer(JwtBearerDefaults.AuthenticationScheme, jwtBearerOptions =>
							{
								jwtBearerOptions.TokenValidationParameters = new TokenValidationParameters
								{
                                    ...
                                    //ValidAudiences = apiConfig.ValidAudiences,
